...
class _BookingScreenState extends State<BookingScreen> {
  ...
  void _showClassPickerDialog() async {
    final value = await showDialog(
        context: context, builder: (_) => const ClassPickerDialog());
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButton(
                ...
                items: const [
                  DropdownMenuItem(
                      value: Coach.susanne, child: Text("Susanne")),
                  DropdownMenuItem(
                      value: Coach.francesca, child: Text("Francesca")),
                ],
                onChanged: (value) {
                  setState(() {
                    _finalCoach = value;
            ...
            DropdownButton(
                ...
                items: const [
                  DropdownMenuItem(
                      value: "30 min", child: Text("30 min - 90€")),
                  DropdownMenuItem(
                      value: "60 min", child: Text("60 min - 160€")),
                ],
                onChanged: (value) {
                  setState(() {
